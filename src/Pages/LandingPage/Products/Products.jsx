  ...
  return (
    <>
      <div className="container-products">
        ...
        <h4 className='App' style={{ color: 'white', wordWrap: 'break-word' }}>We exist to cater to all your chemical requirements.</h4>
        <h6 className='App' style={{ color: 'white', wordWrap: 'break-word' }}>
